				...
				<div class="big-contain" v-if="isLogin">
					...
					<div class="bform" v-if="isForgot">
						...
						<transition name="fade-transform">
							<span class="errTips" v-if="Login_Error_Tip">* 登录信息有误 *
							</span>
						</transition>
					</div>
					<!-- 忘记密码的表单 -->
					<div class="bform" v-else>
						...
						<transition name="fade-transform">
							<span class="errTips" v-if="Login_Error_Tip">* 重置信息有误 *</span>
						</transition>
					</div>
					<div v-if="isForgot">
						<el-button type="success" class="vbutton" @click="login">登录</el-button>
					</div>
					<!-- 忘记密码的按钮部分 -->
					<div v-else>
